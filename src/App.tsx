    ...
    <div className="fixed inset-0 flex flex-col bg-black text-white">
      <div className="flex h-11 shrink-0 items-center border-b border-white/10">
        ...
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center text-white/50 outline-none hover:text-white"
          title="Settings"
        >
          <svg
      ...
      {showSettings && (
        ...
        >
          ...
          >
            ...
            <label className="mb-1 block text-sm text-white/60">Protocol</label>
            <select
